 ...
 * @author PC-USER
 */
public class vDataAnggota1 extends javax.swing.JFrame {
private DefaultTableModel tabmode;
public vPinjaman plg = null;
private ResultSet RsAnggota;
private String trans;
    /**
     * Creates new form vDataAnggota
     */
    public vDataAnggota1() {
        initComponents();
        datatable();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(vDataAnggota1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new vDataAnggota1().setVisible(true);
            }
        });
    }
